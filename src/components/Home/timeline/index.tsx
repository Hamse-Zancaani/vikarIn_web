          ...
          <motion.div
            ...
            <div className='flex flex-col gap-4'>
              ...
              <h2 className='text-white sm:text-40 text-30 font-medium lg:w-80% mx-auto mb-20'>
                Professional temporary staffing solutions for the healthcare sector with a focus on professionalism and flexibility
              </h2>
            </div>
          </motion.div>
          <motion.div
            ...
            <div className='md:block hidden relative'>
              ...
              <div className='absolute lg::top-40 top-36 lg:left-0 -left-20 w-72 flex items-center gap-6'>
                <div className='text-right'>
                  <h5 className='text-muted text-28 mb-3'>Healthcare sector</h5>
                  <p className='text-18 text-muted/60'>
                 Nursing assistants and Social and health assistants
                  </p>
                </div>
              ...
              <div className='absolute lg:top-40 top-36 lg:right-0 -right-20 w-72 flex items-center gap-6'>
                ...
                <div className='text-left'>
                  <h5 className='text-muted text-28 mb-3'>Psychiatry </h5>
                  <p className='text-18 text-muted/60'>
                  qualified temporary workers for psychiatry and related fields
                  </p>
                </div>
              </div>
              <div className='absolute lg:bottom-48 bottom-36 lg:left-0 -left-20 w-72 flex items-center gap-6'>
                <div className='text-right'>
                  <h5 className='text-muted text-28 mb-3'>Student</h5>
                  <p className='text-18 text-muted/60'>
                  Healthcare students seeking practical experience
                  </p>
                </div>
                <div className='bg-light_grey/45 backdrop-blur-xs px-6 py-2 h-fit rounded-full'>
                  <Image
