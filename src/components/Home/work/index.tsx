  ...
  const services = [
    {
      ...
      text: 'Flexible staffing solutions',
    },
    {
      icon: '/images/chooseus/chooseus-icon-2.svg',
      text: 'Short and long-term temporary positions',
    },
    {
      icon: '/images/chooseus/chooseus-icon-3.svg',
      text: 'Permanent positions for the healthcare sector throughout the country',
    },
  ]
          ...
          <motion.div
            ...
            <div className='flex flex-col gap-3'>
              ...
              <h2 className='sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium'>
                We specialize in delivering flexible  solutions for the healthcare sector.
              </h2>
            </div>
