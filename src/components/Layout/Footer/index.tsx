      ...
      <div className='container px-4'>
        <div className='grid grid-cols-1 sm:grid-cols-11 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16'>
          <div className='lg:col-span-4 md:col-span-6 col-span-6 flex flex-col gap-6'>
            <Logo />
            <p className='text-white/60'>Your reliable partner in healthcare temp work. We provide qualified temps 24/7.</p>
        ...
        <p className='text-white/40 text-center py-8 border-t border-white/20'>© 2025 Vikarin. <Link className='hover:text-primary' href={"https://getnextjstemplates.com/"}>.All rights reserved.</Link></p>
      </div>
    </footer>
  )
}
