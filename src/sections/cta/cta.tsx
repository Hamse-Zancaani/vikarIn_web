...
export default function CTA() {
  return (
    <SlideEffect isSpring={false} className="space-y-6 sm:space-y-7 md:space-y-8 lg:space-y-10 mx-auto text-center p-8 md:p-16 flex flex-col items-center justify-center rounded-2xl bg-primary">
      {/* Title */}
      ...
      <Link href={settings.CTA.href}>
        <Button className="w-full text-white bg-black" size='lg'>{settings.CTA.content}</Button>
      </Link>
    </SlideEffect>
  )
}