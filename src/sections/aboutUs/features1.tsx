...
const settings = {
  ...
  card_1: {
    title: 'Goal',
    content: 'Our goal is that our customers and temporary workers always trust us – and that we, in collaboration with our customers and temporary workers, create the best result.',
    carousel_images: [
  ...
  card_2: {
    title: 'Values',
    content: 'Our company is built on trust, and our willpower is that we do everything to meet our customers expectations.'
  },
  card_3: {
    title: 'Vision',
    content: 'We want to become the temporary employment agency in the Danish healthcare sector that best meets the customers needs and wishes.'
  },
  card_4: {
...
export default function Features1() {
  return (
    <div id='features' className="space-y-6 sm:space-y-7 md:space-y-8 lg:space-y-10 mx-auto text-center">
      ...
      {/* Title */}
      <SlideEffect>
        <h2 className="text-2xl md:text-4xl lg:text-header capitalize font-medium leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-black/10">{settings.title}</h2>
      </SlideEffect>
