...
import TextRevealEffect from "@/components/text-blur-effect"
...
export default function Testimonials() {
  return (
    <div id='testimonials' className="space-y-6 sm:space-y-7 md:space-y-8 lg:space-y-10 mx-auto text-center">
      ...
      {/* Title */}
      <TextRevealEffect className="text-2xl md:text-4xl lg:text-header text-transparent bg-clip-text bg-gradient-to-b from-white to-black/10 font-medium leading-normal">{settings.title}</TextRevealEffect>
